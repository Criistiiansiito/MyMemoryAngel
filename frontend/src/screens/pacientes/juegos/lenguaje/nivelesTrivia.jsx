...
const LEVELS = [
  {
    id: 'trivia_facil',
    title: 'Nivel Fácil',
    description: 'Conceptos cotidianos.',
    icon: 'circle-outline',
    color: '#FFFBEB',
    iconColor: '#F59E0B',
  },
  ...
  },
  {
    id: 'trivia_dificil',
    title: 'Nivel Difícil',
    description: 'Desafíos complejos.',
...
const TRIVIA_KEYS = ['trivia_facil', 'trivia_medio', 'trivia_dificil'];
...
export default function NivelesTrivia({ onBack, onSelectDifficulty }) {
  ...
  const summary = useMemo(() => {
    const rows = TRIVIA_KEYS.map((key) => progressMap[key]).filter(Boolean);
    const partidasTotales = rows.reduce((acc, item) => acc + Number(item.partidas_jugadas || 0), 0);
    
    // Cálculo de precisión basado en promedio_puntuacion (10)
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {loading ? (
          ...
          <View style={[styles.settingsCard, { marginTop: 8, alignItems: 'center', paddingVertical: 24 }]}>
            ...
            <Text style={[styles.sectionTitle, { marginTop: 12 }]}>Tu progreso en Trivia</Text>
            <Text style={[styles.menuSubtitle, { marginTop: 8, textAlign: 'center' }]}>
              Juega una partida para desbloquear tus estadísticas de aciertos y récords.
            </Text>
          </View>
        ) : (
          <View style={[styles.settingsCard, { marginTop: 8 }]}>
            <Text style={[styles.sectionTitle, { marginLeft: 0 }]}>Resumen de rendimiento</Text>
            <Text style={[styles.menuSubtitle, { marginTop: 8, marginBottom: 0 }]}>
              Estadísticas generales de todos los niveles.
            </Text>
            ...
            <View style={juegosStyles.statsRow}>
              ...
              <View style={[juegosStyles.cardBase, juegosStyles.cardNeutral]}>
                ...
                <Text style={[styles.menuSubtitle, { marginTop: 10, marginBottom: 4 }, isDarkMode && { color: '#000000' }]}>Partidas</Text>
            ...
            <View style={juegosStyles.statsRowSmall}>
              ...
              <View style={[juegosStyles.cardBase, juegosStyles.cardWarning]}>
                ...
                <Text style={[styles.menuSubtitle, { marginTop: 10, marginBottom: 4 }, isDarkMode && { color: '#FFFFFF' }]}>Mejor récord</Text>
